...
const AboutUs = () => {
    return (
        <div className='about-us grid lg:flex items-center justify-center px-12 py-5 mt-6 bg-slate-900 text-white'>
            <div className='lg:w-1/2 pl-5'>
                ...
                <button className='btn  rounded-3xl px-6 btn-sm mt-4 text-white'>See More</button>
                <h1>change text in my new repository</h1>
            </div>
