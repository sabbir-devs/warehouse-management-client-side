...
const AddReview = () => {
  ...
  return (
    <div className="add-review bg-slate-900 py-5 grid items-center justify-center mt-4 lg:mt-12">
        ...
        <div className="card-body">
          ...
          <form onSubmit={handleReview}>
            ...
            <textarea
              name="review"
              id=""
              className="textarea w-full text-black max-w-xs mt-5"
            ...
            <input
              ...
              className="input text-black mt-2 input-bordered w-full max-w-xs"
              id=""
              required
            />
            <input
